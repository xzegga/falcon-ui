...
export default function LandingPage() {
  ...
  return (
    <div className="h-[100%] flex flex-col justify-center items-center">
      <h1 className="text-3xl text-secondary-800 my-8 font-bold">Tell us your feedback!</h1>
      ...
      <div className="w-2/4 mt-8 flex gap-4 justify-center">
        <Button onClick={()=>router.push('/client/record-feedback')} className="py-2 px-4 rounded">Record Feedback</Button>
        <Button onClick={()=>router.push('/client/live-survey')} className="py-2 px-4 rounded">Live Survey</Button>
        <Button onClick={()=>router.push('/client/talk-carly')} className="py-2 px-4 rounded">Talk to Carly</Button>
      </div>
    </div>
  );
}
